...
String.prototype.lineImage = function(){
    ...
    if(this=="1001"){return "http://15.164.226.64:7080/image/subway_makr_1001.png"}
    else if(this=="1002"){return "http://15.164.226.64:7080/image/subway_makr_1002.png"}
    else if(this=="1003"){return "http://15.164.226.64:7080/image/subway_makr_1003.png"}
    else if(this=="1004"){return "http://15.164.226.64:7080/image/subway_makr_1004.png"}
    else if(this=="1005"){return "http://15.164.226.64:7080/image/subway_makr_1005.png"}
    else if(this=="1006"){return "http://15.164.226.64:7080/image/subway_makr_1006.png"}
    else if(this=="1007"){return "http://15.164.226.64:7080/image/subway_makr_1007.png"}
    else if(this=="1008"){return "http://15.164.226.64:7080/image/subway_makr_1008.png"}
    else if(this=="1009"){return "http://15.164.226.64:7080/image/subway_makr_1009.png"}
