...
Metro.output = function output(room,station){
    ...
    Metro.sendKaling_5list(room,header,title,sub_title,link,mobile_link,THU,NEC)
...
Metro_sendKaling_universal_5list = function Metro_sendKaling_universal_5list(room,header,title,sub_title,link,mobile_link,THU,NEC){
