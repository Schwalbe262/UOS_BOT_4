...
Metro.output = function output(room,station){
    ...
    let header_web_link = ""
    let header_image = "http://"+ip_aws+":7080/image/UOS_logo.png"
    let header_x = "800"
    let header_y = "136"
...
String.prototype.lineImage = function(){
    ...
    if(this=="1001"){return "http://"+ip_aws+":7081/image/subway_mark_1001.png"}
    else if(this=="1002"){return "http://"+ip_aws+":7081/image/subway_mark_1002.png"}
    else if(this=="1003"){return "http://"+ip_aws+":7081/image/subway_mark_1003.png"}
    else if(this=="1004"){return "http://"+ip_aws+":7081/image/subway_mark_1004.png"}
    else if(this=="1005"){return "http://"+ip_aws+":7081/image/subway_mark_1005.png"}
    else if(this=="1006"){return "http://"+ip_aws+":7081/image/subway_mark_1006.png"}
    else if(this=="1007"){return "http://"+ip_aws+":7081/image/subway_mark_1007.png"}
    else if(this=="1008"){return "http://"+ip_aws+":7081/image/subway_mark_1008.png"}
    else if(this=="1009"){return "http://"+ip_aws+":7081/image/subway_mark_1009.png"}
    else if(this=="1063"){return "http://"+ip_aws+":7081/image/subway_mark_1063.png"}
    else if(this=="1065"){return "http://"+ip_aws+":7081/image/subway_mark_1065.png"}
    else if(this=="1067"){return "http://"+ip_aws+":7081/image/subway_mark_1067.png"}
    else if(this=="1071"){return "http://"+ip_aws+":7081/image/subway_mark_1071.png"}
    else if(this=="1075"){return "http://"+ip_aws+":7081/image/subway_mark_1075.png"}
    else if(this=="1077"){return "http://"+ip_aws+":7081/image/subway_mark_1077.png"}
    else if(this=="1092"){return "http://"+ip_aws+":7081/image/subway_mark_1092.png"}
...
String.prototype.lineLink = function(){
    ...
    if(this=="1001"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_line1.png"}
    else if(this=="1002"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_line2.png"}
    else if(this=="1003"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_line3.png"}
    else if(this=="1004"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_line4.png"}
    else if(this=="1005"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_line5.png"}
    else if(this=="1006"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_line6.png"}
    else if(this=="1007"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_line7.png"}
    else if(this=="1008"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_line8.png"}
    else if(this=="1009"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_line9.png"}
    else if(this=="1063"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_lineKY.png"}
    else if(this=="1065"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_lineAP.png"}
    else if(this=="1067"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_lineKC.png"}
    else if(this=="1071"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_lineSI.png"}
    else if(this=="1075"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_lineBD.png"}
    else if(this=="1077"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_lineSBD.png"}
    else if(this=="1092"){return "redirect_UOS?tourl=http://"+ip_aws+":7081/image/subway_map_lineUI.png"}
