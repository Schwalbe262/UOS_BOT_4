...
Metro.parse = function parse(station){
    ...
    let temp
    try{
        temp = body.realtimeStationArrival.row
    }
    catch(e){
        temp = ""
    }
...
Metro.output = function output(room,station){
    ...
    let map_link = "redirect_UOS?tourl=https://www.sisul.or.kr/open_content/skydome/images/img_subway.png"
    let path = [map_link,map_link,map_link,map_link,map_link]
