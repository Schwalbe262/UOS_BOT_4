...
Metro.output = function output(room,station){
    ...
    let NEC = ["http://15.164.226.64:7080/image/animal"+String(Math.floor(Math.random() *10 ))+".jpg","http://15.164.226.64:7080/image/animal"+String(Math.floor(Math.random() *10 ))+".jpg","1"]
