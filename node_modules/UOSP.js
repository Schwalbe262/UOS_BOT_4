...
UOSP.UOS_temp_controller_engineering = function UOS_temp_controller_engineering(opt,mod){
    ...
    if(length==5||mod=="ON"){ // 데이터가 5개가 쌓이면 리턴을 하지 않고 그냥 바로 공지로 내보냄
        ...
        for(let i=0;i<5;i++){
            if(return_data[i]==undefined){
                ...
                URL[i] = String("engineering/korNotice/allList.do?list_id=20013DA1&")
                sub_title[i] = String("전자전기컴퓨터공학부")
            }
            else if(return_data[i][0]=="2"){
                URL[i] = String("engineering/korNotice/allList.do?list_id=20013DA1&cate_id")
                sub_title[i] = String("화학공학과")
            }
            else if(return_data[i][0]=="3"){
                URL[i] = String("engineering/korNotice/allList.do?list_id=20013DA1&cate_id2=000010059&epTicket=INV")
                sub_title[i] = String("기계정보공학과")
            }
            else if(return_data[i][0]=="4"){
                URL[i] = String("engineering/korNotice/allList.do?list_id=20013DA1&cate_id2=000010061&epTicket=INV")
                sub_title[i] = String("신소재공학과")
            }
            else if(return_data[i][0]=="5"){
                URL[i] = String("engineering/korNotice/allList.do?list_id=20013DA1&cate_id2=000010382&epTicket=INV")
                sub_title[i] = String("토목공학과")
            }
            else if(return_data[i][0]=="6"){
                URL[i] = String("engineering/korNotice/allList.do?list_id=20013DA1&cate_id2=000010383&epTicket=INV")
...
UOSP.UOS_temp_controller_biz = function UOS_temp_controller_biz(){

    let result = UOSP.UOS_biz()

    if(result!=undefined){
        let title = result[1]
        let THU = String("")
        let header_title = String("경영학부공지")
        let URL = String("korNotice/list.do")
        let sub_title = String("경영학부")
        for(let i=0;i<Number(roomListNum);i++){
            try{
                UOSP.sendKaling_1list_biz(String(roomList[i]), header_title, title, sub_title, URL, THU)
            }
            catch(e){}
        }
...
UOSP.UOS_social = function UOS_social(opt){ // 정경대학 공지 (array 반환)
    ...
    let body
    if(opt=="1"){body = org.jsoup.Jsoup.connect("https://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&cate_id2=000100002").get()} // 행정학과
    else if(opt=="2"){body = org.jsoup.Jsoup.connect("https://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&cate_id2=000010055&epTicket=ST-331538-EvseKnaZmrZZC4THhvDFMXvsK0UJXZfgCVQ-22").get()} // 국제관계학과
    else if(opt=="3"){body = org.jsoup.Jsoup.connect("https://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&cate_id2=000010057&epTicket=ST-331566-BHszXHC0b5FdFp1RjlWhASutG0tvCmiNkIE-22").get()} // 경제학부
    else if(opt=="4"){body = org.jsoup.Jsoup.connect("https://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&seq=1946&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_id2=000010072&epTicket=ST-331596-moOaQeUAwN1abnAplueCx7KOeWTjskUrALK-22").get()} // 사회복지학과
    else if(opt=="5"){body = org.jsoup.Jsoup.connect("https://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&seq=1958&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_id2=000010074&epTicket=ST-331603-QDYHuHqTOlcLyAXnnIYRKWTORGh77Cw2kj6-22").get()} // 세무학과
...
UOSP.UOS_temp_controller_social = function UOS_temp_controller_social(opt,mod){ // 정경대학

    let result = UOSP.UOS_social(opt)

    let return_data
    if(result!=undefined || mod=="ON"){
        let pre_DB = JSON.parse(UOSP.getDB("UOSP_temp_social"))
        if(result!=undefined){pre_DB.push(result)}
        return_data = pre_DB
        UOSP.setDB("UOSP_temp_social",JSON.stringify(return_data))
    }
    ...
    if(length==5||mod=="ON"){ // 데이터가 5개가 쌓이면 리턴을 하지 않고 그냥 바로 공지로 내보냄
        ...
        for(let i=0;i<5;i++){
            if(return_data[i]==undefined){
                ...
                URL[i] = String("social/korNotice/allList.do?list_id=econo01&cate_id2=000100002")
                sub_title[i] = String("행정학과")
            }
            else if(return_data[i][0]=="2"){
                URL[i] = String("social/korNotice/allList.do?list_id=econo01&cate_id2=000010055&epTicket=ST-331538-EvseKnaZmrZZC4THhvDFMXvsK0UJXZfgCVQ-22")
                sub_title[i] = String("국제관계학과")
            }
            else if(return_data[i][0]=="3"){
                URL[i] = String("https://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&cate_id2=000010057&epTicket=ST-331566-BHszXHC0b5FdFp1RjlWhASutG0tvCmiNkIE-22")
                sub_title[i] = String("경제학부")
            }
            else if(return_data[i][0]=="4"){
                URL[i] = String("https://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&seq=1946&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_id2=000010072&epTicket=ST-331596-moOaQeUAwN1abnAplueCx7KOeWTjskUrALK-22")
                sub_title[i] = String("사회복지학과")
            }
            else if(return_data[i][0]=="5"){
                URL[i] = String("https://social.uos.ac.kr/social/korNotice/allList.do?list_id=econo01&seq=1958&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_id2=000010074&epTicket=ST-331603-QDYHuHqTOlcLyAXnnIYRKWTORGh77Cw2kj6-22")
                sub_title[i] = String("세무학과")
            }
        }
        let THU = ""
        let header_title = "정경대학공지"

        if(mod!="ON"){
            for(let i=0;i<Number(roomListNum);i++){
                try{UOSP.sendKaling_5list_social(String(roomList[i]), header_title, title, sub_title, URL, THU)}
                catch(e){}
            }
        }
        else if(mod=="ON"){
            for(let i=0;i<Number(roomListNum);i++){
                try{
                    if(length==1){UOSP.sendKaling_1list_social(String(roomList[i]), header_title, title, sub_title, URL, THU)}
                    else if(length==2){UOSP.sendKaling_2list_social(String(roomList[i]), header_title, title, sub_title, URL, THU)}
                    else if(length==3){UOSP.sendKaling_3list_social(String(roomList[i]), header_title, title, sub_title, URL, THU)}
                    else if(length==4){UOSP.sendKaling_4list_social(String(roomList[i]), header_title, title, sub_title, URL, THU)}
                    else if(length==5){UOSP.sendKaling_5list_social(String(roomList[i]), header_title, title, sub_title, URL, THU)}
                }
                catch(e){}
            }
        }
...
UOSP.sendKaling_5list_uos = function sendKaling_5list_uos(room, header_title, title, sub_title, path, THU){
...
UOSP.sendKaling_4list_uos = function sendKaling_4list_uos(room, header_title, title, sub_title, path, THU){
...
UOSP.sendKaling_3list_uos = function sendKaling_3list_uos(room, header_title, title, sub_title, path, THU){
...
UOSP.sendKaling_2list_uos = function sendKaling_2list_uos(room, header_title, title, sub_title, path, THU){
...
UOSP.sendKaling_1list_uos = function sendKaling_1list_uos(room, header_title, title, sub_title, path, THU){
...
UOSP.sendKaling_1list_biz = function sendKaling_1list_biz(room, header_title, title, sub_title, path, THU){
...
UOSP.sendKaling_5list_social = function sendKaling_5list_social(room, header_title, title, sub_title, path, THU){
...
UOSP.sendKaling_4list_social = function sendKaling_4list_social(room, header_title, title, sub_title, path, THU){
...
UOSP.sendKaling_3list_social = function sendKaling_3list_social(room, header_title, title, sub_title, path, THU){
...
UOSP.sendKaling_2list_social = function sendKaling_2list_social(room, header_title, title, sub_title, path, THU){
...
UOSP.sendKaling_1list_social = function sendKaling_1list_social(room, header_title, title, sub_title, path, THU){
