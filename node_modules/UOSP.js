...
UOSP.UOS_social = function UOS_social(opt){ // 정경대학 및 인문대학 공지 (array 반환)
    ...
    else if(opt=="14"){body = org.jsoup.Jsoup.connect("https://liberalarts.uos.ac.kr/liberalarts/korNotice/allList.do?list_id=human01&seq=1290&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_i").get()} // 국어국문학과
    ...
    else if(opt=="17"){body = org.jsoup.Jsoup.connect("https://liberalarts.uos.ac.kr/liberalarts/main.do?epTicket=ST-333612-2TdJOttQtS2xetlVY5NBFsEnbU32yqOJlXF-22").get()} // 중국어문화학과
    ...
    else if(opt=="22"){body = org.jsoup.Jsoup.connect("https://science.uos.ac.kr/science/korNotice/view.do?list_id=scien01&seq=1022&sort=1&cate_id2=000010062&epTicket=ST-333736-izMTpFqLyvYrla6Mn3uW2dE15CrMdvjJac6-22").get()} // 환경원예학과
    ...
    if(length==5||mod=="ON"){ // 데이터가 5개가 쌓이면 리턴을 하지 않고 그냥 바로 공지로 내보냄
        ...
        for(let i=0;i<5;i++){
            if(return_data[i]==undefined){
                ...
                URL[i] = String("redirect_UOS?tourl=https://liberalarts.uos.ac.kr/liberalarts/korNotice/allList.do?list_id=human01&seq=1290&sort=0&pageIndex=1&searchCnd=&searchWrd=&viewAuth=Y&cate_i")
                ...
                URL[i] = String("redirect_UOS?tourl=https://liberalarts.uos.ac.kr/liberalarts/main.do?epTicket=ST-333612-2TdJOttQtS2xetlVY5NBFsEnbU32yqOJlXF-22")
                ...
                URL[i] = String("redirect_UOS?tourl=https://science.uos.ac.kr/science/korNotice/view.do?list_id=scien01&seq=1022&sort=1&cate_id2=000010062&epTicket=ST-333736-izMTpFqLyvYrla6Mn3uW2dE15CrMdvjJac6-22")
