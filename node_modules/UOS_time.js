...
var myDB = android.database.sqlite.SQLiteDatabase.openDatabase("/sdcard/katalkbot/Bots/main/UOS_time", null, android.database.sqlite.SQLiteDatabase.CREATE_IF_NECESSARY);

// ================= 방 관련 변수들 ====================
const console_room_name = "시립봇4 컨트롤방" // 콘솔방 이름

UOS_time.UOS_Time_DB_update = function UOS_Time_DB_update(year_,term_,action){ // 시간표업데이트용 #action "I", "U"
...
UOS_time.UOS_Time_DB_update = function UOS_Time_DB_search(key,year_,term_){
...
// 테이블 생성 : myDB2 = android.database.sqlite.SQLiteDatabase.openDatabase("/sdcard/katalkbot/Bots/main/UOS_time", null, android.database.sqlite.SQLiteDatabase.CREATE_IF_NECESSARY);
